...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <asp:Panel ID="Panel1" runat="server" style="text-align: center">
                            ...
                            <div style="text-align:center">
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:DetailsView ID="createInvoiceDetailsView" runat="server" AutoGenerateRows="False" CellPadding="4" DataKeyNames="INVOICE_NUMBER" DataSourceID="CreateInvoiceSQL" ForeColor="#333333" GridLines="None" Height="50px" HorizontalAlign="Center" Width="125px">
                                    ...
                                    <Fields>
                                        ...
                                        <%--not show this because it is automatically inserted by "TRIGGER calculateTotalAmount"--%>
            ...
            <asp:SqlDataSource ID="CreateInvoiceSQL" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringMIS531TeamProject %>" ProviderName="<%$ ConnectionStrings:ConnectionStringMIS531TeamProject.ProviderName %>" SelectCommand="SELECT &quot;INVOICE_NUMBER&quot;, &quot;BILLING_ADDRESS&quot;, &quot;PAID_OR_NOT&quot;, &quot;EMP_ID&quot;, &quot;CLIENT_ID&quot;, &quot;ISSUE_DATE&quot;, &quot;BILL_AMOUNT&quot;, &quot;DUE_DATE&quot;, &quot;DISBURSEMENT_AMOUNT&quot;, &quot;TYPING_FEE&quot;, &quot;WITHHELD_INCOME_TAX&quot;, &quot;TOTAL_AMOUNT&quot;, &quot;DESCRIPTION&quot; FROM &quot;INVOICES&quot; ORDER BY &quot;DUE_DATE&quot;" DeleteCommand="DELETE FROM &quot;INVOICES&quot; WHERE &quot;INVOICE_NUMBER&quot; = :INVOICE_NUMBER" InsertCommand="INSERT INTO &quot;INVOICES&quot; (&quot;INVOICE_NUMBER&quot;, &quot;BILLING_ADDRESS&quot;, &quot;PAID_OR_NOT&quot;, &quot;EMP_ID&quot;, &quot;CLIENT_ID&quot;, &quot;ISSUE_DATE&quot;, &quot;BILL_AMOUNT&quot;, &quot;DUE_DATE&quot;, &quot;DISBURSEMENT_AMOUNT&quot;, &quot;TYPING_FEE&quot;, &quot;WITHHELD_INCOME_TAX&quot;, &quot;TOTAL_AMOUNT&quot;, &quot;DESCRIPTION&quot;) VALUES (:INVOICE_NUMBER, :BILLING_ADDRESS, :PAID_OR_NOT, :EMP_ID, :CLIENT_ID, :ISSUE_DATE, :BILL_AMOUNT, :DUE_DATE, :DISBURSEMENT_AMOUNT, :TYPING_FEE, :WITHHELD_INCOME_TAX, :TOTAL_AMOUNT, :DESCRIPTION)" UpdateCommand="UPDATE &quot;INVOICES&quot; SET &quot;BILLING_ADDRESS&quot; = :BILLING_ADDRESS, &quot;PAID_OR_NOT&quot; = :PAID_OR_NOT, &quot;EMP_ID&quot; = :EMP_ID, &quot;CLIENT_ID&quot; = :CLIENT_ID, &quot;ISSUE_DATE&quot; = :ISSUE_DATE, &quot;BILL_AMOUNT&quot; = :BILL_AMOUNT, &quot;DUE_DATE&quot; = :DUE_DATE, &quot;DISBURSEMENT_AMOUNT&quot; = :DISBURSEMENT_AMOUNT, &quot;TYPING_FEE&quot; = :TYPING_FEE, &quot;WITHHELD_INCOME_TAX&quot; = :WITHHELD_INCOME_TAX, &quot;TOTAL_AMOUNT&quot; = :TOTAL_AMOUNT, &quot;DESCRIPTION&quot; = :DESCRIPTION WHERE &quot;INVOICE_NUMBER&quot; = :INVOICE_NUMBER">
                <DeleteParameters>
        ...
        <p style="text-align: center">
            ...
            <asp:SqlDataSource ID="CreateContractInvoieSQL" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringMIS531TeamProject %>" DeleteCommand="DELETE FROM &quot;CONTRACT_INVOICES&quot; WHERE &quot;INVOICE_NUMBER&quot; = :INVOICE_NUMBER" InsertCommand="INSERT INTO &quot;CONTRACT_INVOICES&quot; (&quot;INVOICE_NUMBER&quot;, &quot;CONTRACT_ID&quot;) VALUES (:INVOICE_NUMBER, :CONTRACT_ID)" ProviderName="<%$ ConnectionStrings:ConnectionStringMIS531TeamProject.ProviderName %>" SelectCommand="SELECT * FROM &quot;CONTRACT_INVOICES&quot; ORDER BY &quot;CONTRACT_ID&quot;" UpdateCommand="UPDATE &quot;CONTRACT_INVOICES&quot; SET &quot;CONTRACT_ID&quot; = :CONTRACT_ID WHERE &quot;INVOICE_NUMBER&quot; = :INVOICE_NUMBER">
                <DeleteParameters>
                    <asp:Parameter Name="INVOICE_NUMBER" Type="String" />
                </DeleteParameters>
                <InsertParameters>
